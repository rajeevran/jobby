module.exports =
  '<body style="padding: 0;margin: 0;font-family: Arial, Helvetica, sans-serif;">\
        <div style="width:600px;margin:0 auto;background-image: url({{ site_url }}uploads/email_template/top_bg.png);background-repeat: no-repeat;">\
            ...
            <p>Hi, <b>{{ name }}</b></p>\
            <p>As per your request, Your account has been deleted permanantly from Ezfoodie.You"ll lose access your account in Ezfoodie.</p>\
            <p>Thank you for your valuable time spends with us.</p>\
            </div>\
